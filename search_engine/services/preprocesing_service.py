...
from typing import DefaultDict, Set, Protocol
...
class AbstractPreprocesingService(Protocol):
    ...
    def process(self, doc_name: str, doc: str, dictionary: DefaultDict[str, DefaultDict[str, Set]]) \
...
class RawPreprocesingService(AbstractPreprocesingService):
    ...
    def process(self, doc_name: str, doc: str, dictionary: DefaultDict[str, DefaultDict[str, Set]] = None)\
            -> DefaultDict[str, DefaultDict[str, Set]]:
        """
